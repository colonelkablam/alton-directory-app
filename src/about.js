  ...
  return (
    <div className="container">
      ...
      <div className="detailed-card">
        ...
        <p className="boldPara">Please note: The information provided in this directory is for reference only. Users assume full responsibility for their use of  the services listed.</p>
        ...
        <p>Queries? Please email Laura Bassett at: <p className="boldPara">&nbsp; bugbearworkshops@gmail.com</p></p>
